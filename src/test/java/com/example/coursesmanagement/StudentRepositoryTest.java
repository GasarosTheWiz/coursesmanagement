...
class StudentRepositoryTest {
	...
	void testCreateStudent() {
		StudentID student1ID = new StudentID(2766,
				"Software Engineering");
		StudentID student2ID = new StudentID(2766,
				"Algebra");
		StudentID student3ID = new StudentID(4100,
				"Software Engineering");
		
		Student student1 = new Student(student1ID,
				"Evangelos Barmpalias",
				2014,
				16); 
		...
		Student existStudent = studentRepository.findByIdAndEnrolledCourse(2766, "Software Engineering");
	...
	void testFindStudent() {
		Integer studentID = 2766;
		String studentFullName = "Evangelos Barmpalias";
